...
def getEvoSuiteCall(seed, configId, config, project, clazz, id, strategy, coreIndex):
  ...
  result += ' -Dconfiguration_id=EvoSuite'
  result += " -projectCP " + class_path
  result += ' -Doutput_variables=TARGET_CLASS,criterion,configuration_id,Total_Goals,Total_Branches,Lines,Covered_Goals,Generations,Statements_Executed,Fitness_Evaluations,Tests_Executed,Generations,Total_Time,Size,Result_Size,Length,Result_Length,BranchCoverage,Random_Seed'
